...
export class FollowService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getUsersUserIDFollowing(userID: number, limit?: number, offset?: number, ): Observable<AxiosResponse<UserList>>;
    public getUsersUserIDFollowing(userID: number, limit?: number, offset?: number, ): Observable<any> {
        ...
        return this.httpClient.get<UserList>(`${this.basePath}/users/${encodeURIComponent(String(userID))}/following`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getUsersUserIdFriends(userID: number, limit?: number, offset?: number, ): Observable<AxiosResponse<UserList>>;
    public getUsersUserIdFriends(userID: number, limit?: number, offset?: number, ): Observable<any> {
        ...
        return this.httpClient.get<UserList>(`${this.basePath}/users/${encodeURIComponent(String(userID))}/followers`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers
